    ...
    <div className="flex flex-1 overflow-hidden">
      ...
      >
        <div className="h-12 flex items-center px-4 border-b bg-card shrink-0 gap-2">
          <h1 className="flex-1 text-3xs font-semibold text-ink-400 uppercase tracking-wider whitespace-nowrap">Notes</h1>
          <button
        ...
        <div className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-h-0 px-3 py-3">
          ...
          <div className="bg-card rounded-lg border border-border/60 px-2 pb-2 pt-1">
            <Calendar
              ...
              classNames={{
                ...
                weekday: 'flex-1 text-center text-3xs font-medium text-ink-400 select-none',
          ...
          {/* Vault 섹션 */}
          <div>
            <div className="text-3xs font-semibold text-ink-400 uppercase tracking-wider mb-2">Vault</div>
            ...
            {patternEditing && (
              <div className="mt-2 space-y-1.5">
                <p className="text-3xs text-ink-400 px-1">예: Daily Notes/YYYY-MM-DD</p>
                <input
                  autoFocus
                  value={patternDraft}
