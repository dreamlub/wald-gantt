  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-background">
      <div className="h-12 bg-card border-b border-border flex items-center px-4 shrink-0">
        <h1 className="text-xs font-semibold text-foreground">설정</h1>
      </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        <aside className="w-[200px] shrink-0 bg-card border-r border-border py-2.5 px-1.5">
          ...
          <div className="flex items-center gap-2 px-2.5 py-2 rounded-sm bg-ink-100 text-foreground text-xs font-semibold">
            <KeyRound size={15} />
            클라이언트 키워드
          </div>
        </aside>
              ...
              <div className="px-4 py-3.5">
                ...
                <div className="flex gap-1.5 items-center">
                  <input
                    ...
                    className="bg-card border border-border rounded-sm px-2.5 py-1.5 text-xs w-40 outline-none focus:border-lilac-400 transition-colors"
                  />
                  <button
                    onClick={() => addKw(c.id)}
                    className="inline-flex items-center gap-1.5 h-[30px] px-3 rounded-sm bg-card border border-border text-foreground text-xs font-medium hover:bg-ink-100 transition-colors"
                  >
                    <Plus size={14} /> 추가
                  </button>
                </div>
