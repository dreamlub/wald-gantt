      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full border-collapse text-xs">
          <thead className="sticky top-0 z-10 bg-muted border-b border-ink-150">
            <tr>
              <th
                className="text-left px-5 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider cursor-pointer select-none hover:text-foreground whitespace-nowrap"
              ...
              <th className="text-left px-5 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider w-[180px]">주제</th>
              <th className="text-left px-5 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider min-w-[240px]">요약</th>
              <th className="text-left px-5 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider">태그</th>
              <th
                className="text-center px-5 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider cursor-pointer select-none hover:text-foreground whitespace-nowrap"
                onClick={() => toggleSort('priority')}
              >
                <span className="flex items-center justify-center gap-1">중요도 <SortIcon active={sortKey === 'priority'} dir={sortDir} /></span>
              </th>
              <th
                className="text-right px-5 py-2 text-xs font-semibold text-ink-400 uppercase tracking-wider cursor-pointer select-none hover:text-foreground whitespace-nowrap"
              ...
              return (
                <tr key={row.id} className="border-t border-border hover:bg-muted/40 transition-colors align-top">
                  ...
                  <td className="px-5 py-2 whitespace-nowrap tabular-nums">
                    ...
                    <div className="text-xs text-ink-400 mt-0.5">{getWeekRange(row.week_start)}</div>
                  </td>
          ...
          <tfoot className="sticky bottom-0 bg-muted border-t border-ink-150">
            <tr>
              <td colSpan={7} className="px-5 py-2 text-right text-xs text-ink-400 tabular-nums">
                {filtered.length === 0
