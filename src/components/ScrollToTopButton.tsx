...
export function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      aria-label="맨 위로"
      className={`fixed bottom-6 right-6 z-overlay w-9 h-9 rounded-full bg-foreground text-background shadow-lg flex items-center justify-center transition-all duration-200 ${
