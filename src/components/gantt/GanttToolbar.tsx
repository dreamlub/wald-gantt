    ...
    <div className="flex items-center justify-between px-5 py-2 border-b shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={sortRef}>
          ...
          {showSort && (
            <div className="absolute right-0 top-full mt-1 bg-white border rounded-lg shadow-lg z-50 min-w-[140px] py-1">
        ...
        {!readOnly && onAddCategory && (
          <button
            ...
            className="flex items-center gap-1 text-xs font-medium text-gray-500 hover:text-indigo-600 border border-gray-200 hover:border-indigo-300 px-3 py-1.5 rounded transition-colors"
          >
            <Plus size={13} /> 카테고리
          </button>
        )}
